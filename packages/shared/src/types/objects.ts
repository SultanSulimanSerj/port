...
export const ObjectMemberDtoSchema = z.object({
  userId: UuidSchema,
  role: ObjectRole,
  isResponsible: z.boolean().default(false),
});
export type ObjectMemberDto = z.infer<typeof ObjectMemberDtoSchema>;

export const AddObjectMemberDtoSchema = ObjectMemberDtoSchema;
